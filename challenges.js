...
var requireUserCount = function(userCount) {
	return {
		description: "Transport <span class='emphasis-color'>" + userCount + "</span> people",
		evaluate: function(world) {
...
var challenges = [
	...
	{
		options: { floorCount: 21, elevatorCount: 8, spawnRate: 3.3, elevatorCapacities: [6, 8], fireExit: true },
		condition: requireUserCount(10000),
	},
	{
		options: { floorCount: 21, elevatorCount: 8, spawnRate: 2, elevatorCapacities: [6, 8] },
